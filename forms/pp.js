...
document.getElementById("submitBtn").onclick = () => {
    ...
    let sub1Marks = document.getElementById("sub1Marks");
    console.log(document)
    console.log(`Subject1 Marks:${sub1Marks.value}`)

    console.log(`Subject2 Marks:${document.getElementById("sub2Marks").value}`)

    console.log(`Subject3 Marks:${document.getElementById("sub3Marks").value}`)


    console.log(`Subject4 Marks:${document.getElementById("sub4Marks").value}`)


    console.log(`Subject5 Marks:${document.getElementById("sub5Marks").value}`)

    console.log(`Subject6 Marks:${document.getElementById("sub6Marks").value}`)


    let totalMarks = document.getElementById("totalMarks").value;
    let averageMarks = document.getElementById("averageMarks").value;
    let Subject1Marks = parseInt(sub1Marks.value);
...
document.getElementById("submit1Btn").onclick = () => {
    ...
    console.log(`Subject21 Marks:${document.getElementById("sub21Marks").value
        }`)
    console.log(`Subject22 Marks:${document.getElementById("sub22Marks").value}`)

    console.log(`Subject23 Marks:${document.getElementById("sub23Marks").value}`)


    console.log(`Subject24 Marks:${document.getElementById("sub24Marks").value}`)


    console.log(`Subject25 Marks:${document.getElementById("sub25Marks").value}`)

    console.log(`Subject26 Marks:${document.getElementById("sub26Marks").value}`)
...
document.getElementById("submit2Btn").onclick = () => {
    ...
    console.log(document)
    console.log(`Subject31 Marks:${document.getElementById("sub31Marks").value
        }`)
    console.log(`Subject32 Marks:${document.getElementById("sub32Marks").value}`)

    console.log(`Subject33 Marks:${document.getElementById("sub33Marks").value}`)


    console.log(`Subject34 Marks:${document.getElementById("sub34Marks").value}`)


    console.log(`Subject35 Marks:${document.getElementById("sub35Marks").value}`)

    console.log(`Subject36 Marks:${document.getElementById("sub36Marks").value}`)
...
document.getElementById("submit3Btn").onclick = () => {
    ...
    console.log(document)
    console.log(`Subject41 Marks:${document.getElementById("sub41Marks").value
        }`)
    console.log(`Subject42 Marks:${document.getElementById("sub42Marks").value}`)

    console.log(`Subject43 Marks:${document.getElementById("sub43Marks").value}`)


    console.log(`Subject44 Marks:${document.getElementById("sub44Marks").value}`)


    console.log(`Subject45 Marks:${document.getElementById("sub45Marks").value}`)

    console.log(`Subject46 Marks:${document.getElementById("sub46Marks").value}`)
...
document.getElementById("submit4Btn").onclick = () => {
    ...
    console.log(document)
    console.log(`Subject51 Marks:${document.getElementById("sub51Marks").value
        }`)
    console.log(`Subject52 Marks:${document.getElementById("sub52Marks").value}`)

    console.log(`Subject53 Marks:${document.getElementById("sub53Marks").value}`)


    console.log(`Subject54 Marks:${document.getElementById("sub54Marks").value}`)


    console.log(`Subject55 Marks:${document.getElementById("sub55Marks").value}`)

    console.log(`Subject56 Marks:${document.getElementById("sub56Marks").value}`)
...
document.getElementById("submit5Btn").onclick = () => {
    ...
    console.log(document)
    console.log(`Subject61 Marks:${document.getElementById("sub61Marks").value
        }`)
    console.log(`Subject62 Marks:${document.getElementById("sub62Marks").value}`)

    console.log(`Subject63 Marks:${document.getElementById("sub63Marks").value}`)


    console.log(`Subject64 Marks:${document.getElementById("sub64Marks").value}`)


    console.log(`Subject65 Marks:${document.getElementById("sub65Marks").value}`)

    console.log(`Subject66 Marks:${document.getElementById("sub66Marks").value}`)
